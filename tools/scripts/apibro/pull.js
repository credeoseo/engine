...
function fetchSpec(specUrl) {
  ...
  // Using git archive to fetch a single file from GitLab
  // git archive --remote=git@gitlab.com:path/to/your-project.git HEAD path/to/openapi-file.yml --output=test.md
  // git archive --remote=git@gitlab.com:path/to/your-project.git HEAD path/to/openapi-file.yml | tar -xO 
